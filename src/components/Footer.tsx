        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 py-10">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-[11px] text-emerald-500 font-bold uppercase tracking-wider">
                  {settings.tagline || 'Panadería & Delicias de Apurímac'}
                </p>
              </div>
            </div>
            ...
            {(settings.showTiktok !== false ||
              ...
              <div className="pt-2">
                ...
                <div className="flex items-center gap-2.5 flex-wrap">
                  {/* TikTok */}
                  {settings.showTiktok !== false && settings.tiktokUrl && (
                    <a
                  ...
                  {/* WhatsApp Direct */}
                  {settings.showWhatsapp !== false && settings.whatsappPhone && (
                    <a
                ...
                <li>
                  ...
                  >
                    ...
                    <div>
                      ...
                      <strong className="text-xs font-semibold">{settings.phone}</strong>
                    </div>
                  </a>
                </li>
              )}
                ...
                <li>
                  ...
                  >
                    ...
                    <div>
                      ...
                      <strong className="text-xs font-semibold">+{settings.whatsappPhone}</strong>
                    </div>
                  </a>
                </li>
              )}
          ...
          <div className="space-y-3">
            ...
            <div className="space-y-3 text-xs">
              {settings.showAddress !== false && settings.addressText && (
                <div className="flex items-start gap-2.5">
                  ...
                  <div>
                    ...
                    <p className="leading-snug">{settings.addressText}</p>
                  </div>
                </div>
              )}

              {settings.showHours !== false && settings.businessHours && (
                <div className="flex items-start gap-2.5">
          ...
          <div className="space-y-3">
            ...
            {settings.showShippingInfo !== false && (
              <p className={`text-xs ${isDarkMode ? 'text-slate-400' : 'text-slate-600'}`}>
                {settings.footerShippingInfo ||
            ...
            {settings.showPaymentBadges !== false && (
